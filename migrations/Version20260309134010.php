 ...
 */
final class Version20260309134010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE soiree_artist (soiree_id INT NOT NULL, artist_id INT NOT NULL, INDEX IDX_60509CE7BA021F7B (soiree_id), INDEX IDX_60509CE7B7970CF8 (artist_id), PRIMARY KEY (soiree_id, artist_id)) DEFAULT CHARACTER SET utf8mb4');
